...
class ProjectBuild extends Command {
    ...
    onExec() {
        ...
        const commands = [
            {
                command: 'parcel build --no-cache --no-source-maps --log-level verbose --dist-dir public screen/screen.html',
                name: 'screen',
                prefixColor: Color.BLUE,
                cwd: rootPath
            },
            {
                command: 'parcel build --no-cache --no-source-maps --log-level verbose --dist-dir public controller/controller.html',
                name: 'controller',
